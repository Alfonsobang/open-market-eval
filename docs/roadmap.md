...
## v0.3: agent research harness

- Add OpenAI-compatible and local-model adapters.
- Capture tool traces, source diversity, latency, and research cost.
- Add repeated trials and bootstrap confidence intervals.
...
- Brokerage execution or portfolio automation.
- Buy/sell recommendations and price targets.
- Claims of market-beating performance from synthetic or hindsight-exposed data.
